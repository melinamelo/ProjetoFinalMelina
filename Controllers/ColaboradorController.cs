    ...
    public class ColaboradorController : Controller
    {
        ...
        public async Task<IActionResult> Index(string pesquisa)
        {
            if (pesquisa == null)
            {
                ...
                .Include(l => l.TipoColaborador)
                .Include(l => l.Cidade);
                return View(await contexto.OrderBy(x => x.ColaboradorNome).ToListAsync());
            }
            else
            {
                var contexto = _context.Colaborador
                .Include(l => l.TipoColaborador)
                .Include(l => l.Cidade)
                .OrderBy(x => x.ColaboradorNome)
                .Where(e => e.ColaboradorNome.Contains(pesquisa));
