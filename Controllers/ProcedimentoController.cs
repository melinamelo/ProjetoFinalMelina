        ...
        public async Task<IActionResult> Index(string pesquisa)
        {
            if (pesquisa == null)
            {
                return _context.Procedimento != null ?
                          View(await _context.Procedimento.Include(x => x.TipoProcedimento).OrderBy(x => x.ProcedimentoNome).ToListAsync()) :
            ...
            else
            {
                ...
                var contexto = _context.Procedimento
                          .Include(x => x.TipoProcedimento)
                          .OrderBy(x => x.ProcedimentoNome)
                          .Where(e => e.ProcedimentoNome.Contains(pesquisa));
